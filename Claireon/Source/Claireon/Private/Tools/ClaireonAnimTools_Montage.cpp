...
{
	return TEXT("Add a section to a montage at a specific time.");
}
...
{
	return TEXT("Remove a section from a montage.");
}
...
{
	return TEXT("Set which section plays next after a given section.");
}
...
{
	return TEXT("Set the link method for a montage section.");
}
...
{
	return TEXT("Add an animation segment to a montage slot.");
}
...
{
	return TEXT("Remove a segment from a montage slot.");
}
...
{
	return TEXT("Set a property on a montage segment.");
}
...
{
	return TEXT("Add a new slot track to a montage.");
}
...
{
	return TEXT("Remove a slot track from a montage. Cannot remove the last slot.");
}
...
{
	return TEXT("Rename a montage slot.");
}
...
{
	return TEXT("Get detailed info about a montage segment including linked notifies.");
}
...
{
	return TEXT("Change the timing of a montage segment. Optionally retimes contained notifies.");
}
...
{
	return TEXT("Find all montages referencing an animation and retime their segments after the animation changed length.");
}
