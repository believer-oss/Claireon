...
{
    return TEXT("[Backlogged] Rename a UWidgetAnimation. Implementation deferred to the backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("rename_animation is not yet implemented; tracked in the backlog: https://example.com/internal-doc"));
}
