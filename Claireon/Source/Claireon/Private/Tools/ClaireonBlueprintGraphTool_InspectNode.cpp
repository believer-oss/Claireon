...
FToolResult ClaireonBlueprintGraphTool_InspectNode::Execute(const TSharedPtr<FJsonObject>& Arguments)
{
    TSharedPtr<FJsonObject> Params;
    FString SessionId;
    FBlueprintEditToolData* Data = nullptr;
    FToolResult Error;
    if (!BeginSessionOp(Arguments, TEXT("inspect_node"), Params, SessionId, Data, Error))
    {
        return Error;
    }
