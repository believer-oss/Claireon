...
{
    return TEXT("[Backlogged] Duplicate a UWidgetAnimation under a new name. Implementation deferred to the backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("duplicate_animation is not yet implemented; tracked in the backlog: https://example.com/internal-doc"));
}
