...
{
    return TEXT("[Backlogged] Add a keyframe to a widget animation track. Implementation deferred to the backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("add_animation_keyframe is not yet implemented; tracked in the backlog: https://example.com/internal-doc"));
}
