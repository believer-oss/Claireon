...
{
    return TEXT("[Backlogged] Set a property on a UWidgetAnimation (duration, loop count, etc.). Implementation deferred to the backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("set_animation_property is not yet implemented; tracked in the backlog: https://example.com/internal-doc"));
}
