...
FString ClaireonBlueprintGraphTool_AddInterface::GetOperation() const { return TEXT("add_interface"); }
...
FToolResult ClaireonBlueprintGraphTool_AddInterface::Execute(const TSharedPtr<FJsonObject>& Arguments)
{
    TSharedPtr<FJsonObject> Params;
    FString SessionId;
    FBlueprintEditToolData* Data = nullptr;
    FToolResult Error;
    if (!BeginSessionOp(Arguments, TEXT("add_interface"), Params, SessionId, Data, Error))
    {
        return Error;
    }
