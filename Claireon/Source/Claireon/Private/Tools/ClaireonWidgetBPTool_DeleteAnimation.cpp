...
{
    return TEXT("[Backlogged] Delete a UWidgetAnimation by name. Implementation deferred to the backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("delete_animation is not yet implemented; tracked in the backlog: https://example.com/internal-doc"));
}
