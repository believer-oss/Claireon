...
{
    return TEXT("[Backlogged] Inspect tracks, bindings, and keyframes on a UWidgetAnimation. Implementation deferred to Dispatch Backlog: https://example.com/internal-doc.");
}
...
{
    return MakeErrorResult(TEXT("get_animation_details is not yet implemented; tracked in Dispatch Backlog: https://example.com/internal-doc"));
}
