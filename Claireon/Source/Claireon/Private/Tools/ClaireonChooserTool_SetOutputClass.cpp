...
{
    return TEXT("Set the output object class (OutputObjectType) on a ChooserTable. Stateless / non-session: writes the asset directly by path, no open session required.");
}
