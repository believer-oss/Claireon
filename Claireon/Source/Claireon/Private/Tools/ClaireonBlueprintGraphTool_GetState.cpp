...
FString ClaireonBlueprintGraphTool_GetState::GetName() const
{
    return TEXT("claireon.blueprint_graph_get_state");
}
...
FToolResult ClaireonBlueprintGraphTool_GetState::Execute(const TSharedPtr<FJsonObject>& Arguments)
{
