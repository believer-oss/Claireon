...
FString ClaireonTool_DataTableExportJson::GetCategory() const { return TEXT("datatable"); }
FString ClaireonTool_DataTableExportJson::GetOperation() const { return TEXT("export_json"); }
