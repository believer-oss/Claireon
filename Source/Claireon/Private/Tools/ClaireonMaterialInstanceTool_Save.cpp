...
{
    return TEXT("Save the UMaterialInstanceConstant's package to disk for the current session. Session-mode tool: open via material_instance_instance_open first.");
}
