...
{
    return TEXT("Clear a vector parameter override on a UMaterialInstanceConstant; the parameter falls through to the parent material. Session-mode tool: open via material_instance_instance_open first.");
}
