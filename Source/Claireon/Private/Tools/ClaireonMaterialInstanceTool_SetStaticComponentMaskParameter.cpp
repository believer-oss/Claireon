...
{
    return TEXT("Set a static component mask parameter override on a UMaterialInstanceConstant (triggers shader-map rebuild). Session-mode tool: open via material_instance_instance_open first.");
}
