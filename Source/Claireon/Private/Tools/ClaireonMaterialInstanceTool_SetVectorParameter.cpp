...
{
    return TEXT("Set a vector (LinearColor) parameter override on a UMaterialInstanceConstant. Session-mode tool: open via material_instance_instance_open first.");
}
