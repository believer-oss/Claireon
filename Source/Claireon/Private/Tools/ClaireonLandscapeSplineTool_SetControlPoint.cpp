...
{
    return TEXT("Modify properties of an existing spline control point (location, rotation, width, side falloff). Session-mode tool: open via landscape_spline_spline_open first.");
}
