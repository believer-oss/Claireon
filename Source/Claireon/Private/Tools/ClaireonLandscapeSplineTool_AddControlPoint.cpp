...
{
    return TEXT("Create a new spline control point with the given location, rotation, width, and side falloff. Session-mode tool: open via landscape_spline_spline_open first.");
}
